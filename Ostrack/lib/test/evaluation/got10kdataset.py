...
class GOT10KDataset(BaseDataset):
    ...
    def __init__(self, split):
        ...
        if split == 'test' or split == 'val':
            ...
            # self.base_path = os.path.join('/root/autodl-tmp/ostrack/OSTrack-main/data/UAV', split)
            self.base_path = os.path.join('/root/autodl-tmp/ostrack/OSTrack-main/data/UAV', 'train')
        else:
    ...
    def _get_sequence_list(self, split):
        with open('{}/splitTestList.txt'.format(self.base_path)) as f: # 之前是list.txt
